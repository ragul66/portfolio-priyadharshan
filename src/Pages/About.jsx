...
const About = () => {
  return (
    <div
      id="about"
      className=" lg:space-x-24 bg-gradient-to-r from-indigo-900 to-blue-600 h-full md:max-h-screen text-white p-5 sm:p-10 flex flex-col lg:flex-row items-center font-primary"
    >
      {/* Left Section - Image */}
      ...
      <div className="flex-1 lg:pl-12  ">
        ...
        <p className="text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed font-light max-w-3xl">
          ...
          focus on innovation, efficiency, and precision. My background is
          further enriched by internships and workshops that have solidified my
          technical expertise. In addition to my technical and project
          management skills, I hold a NEBOSH certification and an Irish driving
          license. My proactive involvement in sports and cultural events
